...
public:
  ...
  KSettingsDialog(k4dirstat *mainWin);
...
public:
   ...
   * Constructor
   **/
  KTreeColorsPage(QWidget *parent, k4dirstat *mainWin);
...
public:
   ...
   * Constructor
   **/
  KCleanupPage(QWidget *parent, k4dirstat *mainWin);
...
public:
   ...
   * Constructor.
   **/
  KCleanupListBoxItem(KCleanupListBox *listBox, KCleanup *cleanup);
...
public:
   ...
   * Constructor
   **/
  KCleanupPropertiesPage(QWidget *parent, k4dirstat *mainWin);
...
public:
   ...
   * Constructor
   **/
  KGeneralSettingsPage(QWidget *parent, k4dirstat *mainWin);
...
public:
   ...
   * Constructor
   **/
  KTreemapPage(QWidget *parent, k4dirstat *mainWin);
...
protected:
   ...
   **/
  QColor readColorEntry(KConfigGroup config, const char *entryName,
                        QColor defaultColor);
