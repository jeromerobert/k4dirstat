...
protected slots:
   ...
   **/
  void entries(KIO::Job *job, const KIO::UDSEntryList &entryList);
...
public:
   ...
   * current tree items.
   **/
  KCacheReadJob(KDirTree *tree, KDirInfo *parent, KCacheReader *reader);
   ...
   * current tree items.
   **/
  KCacheReadJob(KDirTree *tree, KDirInfo *parent, const QString &cacheFileName);
