...
public:
   ...
   **/
  KCleanup(QString id, QString command, QString title);
  ...
  void setRefreshPolicy(enum RefreshPolicy refreshPolicy) {
...
protected:
   ...
   **/
  void runCommand(const KFileInfo *item, const QString &command) const;
