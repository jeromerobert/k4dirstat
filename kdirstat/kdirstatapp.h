 ...
 *   Updated:	2001-11-25
 *
 *   $Id: kdirstatapp.h,v 1.4 2001/11/27 09:40:18 hundhammer Exp $
 *
 */
...
protected:
    ...
    /**
     * Set up the tree view's context menu.
     **/
...
public slots:
     ...
     **/
    void slotSelectionChanged( KFileInfo *selection );
     ...
     **/
    void slotContextMenu( KDirTreeViewItem *item, const QPoint &pos );
...
protected:
    ...
    KAction * 			fileAskOpenDir;
    KRecentFilesAction *	fileOpenRecent;
    KAction * 			fileCloseDir;
    KAction * 			fileRefreshAll;
    KAction *			fileRefreshSelected;
    KAction * 			fileQuit;
    KAction * 			editCopy;
